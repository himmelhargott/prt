import require$$0 from '../../../../../_snowpack/pkg/async.js';
...
(function () {
  var root = {};
  // Dependencies --------------------------------------------------------------
  root.async = (typeof commonjsRequire === 'function') ? require$$0 : window.async;
...
var Sanitization = schemaInspector$1.Sanitization;
var Validation = schemaInspector$1.Validation;
export default schemaInspector$1;
var generate = schemaInspector$1.generate;
var newSanitization = schemaInspector$1.newSanitization;
var newValidation = schemaInspector$1.newValidation;
var sanitize = schemaInspector$1.sanitize;
var validate = schemaInspector$1.validate;
export { Sanitization, Validation, schemaInspector$1 as __moduleExports, generate, newSanitization, newValidation, sanitize, validate };
