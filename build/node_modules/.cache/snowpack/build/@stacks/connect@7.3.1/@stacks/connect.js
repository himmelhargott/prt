import { AppConfig, UserSession } from '../../../../../../../_snowpack/pkg/@stacks/auth.js';
export * from '../../../../../../../_snowpack/pkg/@stacks/auth.js';
import { decodeToken, SECP256K1Client, TokenSigner, createUnsecuredToken } from '../../../../../../../_snowpack/pkg/jsontokens.js';
import { StacksTestnet } from '../../../../../../../_snowpack/pkg/@stacks/network.js';
import { ChainID, serializeCV, serializePostCondition, deserializeTransaction } from '../../../../../../../_snowpack/pkg/@stacks/transactions.js';
import { defineCustomElements } from '../../../../../../../_snowpack/pkg/@stacks/connect-ui/loader.js';
...
var H = () => {
  ...
  return /android/i.test(t) || /iPad|iPhone|iPod/.test(t) ? true : /windows phone/i.test(t);
}, Qt = () => !H(), B = (t) => {
  if (!t) {
  ...
  try {
    ...
    let h = decodeToken(T), X = h == null ? void 0 : h.payload;
...
var y = (t) => {
  let n = x(t).loadUserData().appPrivateKey, r = SECP256K1Client.derivePublicKey(n);
...
async function C(t, e) {
  ...
  return n && typeof n[0] != "string" && (n = E(n)), new TokenSigner("ES256k", e).signAsync(p(i({}, t), {postConditions: n}));
}
function w(t) {
  let {postConditions: e} = t;
  return e && typeof e[0] != "string" && (e = E(e)), createUnsecuredToken(p(i({}, t), {postConditions: e}));
}
var at = async ({token: t, options: e}) => {
  ...
  let o = t, {appDetails: e, userSession: n} = o, r = f(o, ["appDetails", "userSession"]);
  if (g(n)) {
    let {privateKey: a, publicKey: c} = y(n), u = p(i({}, r), {publicKey: c, txType: "smart_contract"});
    return e && (u.appDetails = e), C(u, a);
  }
  let s = p(i({}, r), {txType: "smart_contract"});
  return e && (s.appDetails = e), w(s);
}, ut = async (t) => {
  let a = t, {amount: e, appDetails: n, userSession: r} = a, s = f(a, ["amount", "appDetails", "userSession"]);
  if (g(r)) {
    let {privateKey: c, publicKey: u} = y(r), l = p(i({}, s), {amount: e.toString(10), publicKey: u, txType: "token_transfer"});
    return n && (l.appDetails = n), C(l, c);
  }
  let o = p(i({}, s), {amount: e.toString(10), txType: "token_transfer"});
...
async function gt(t, e) {
  return new TokenSigner("ES256k", e).signAsync(i({}, t));
}
function yt(t) {
  let e = t.network || new StacksTestnet(), n = x(t.userSession), r = p(i({}, t), {network: e, userSession: n});
  return i({}, r);
...
var mt = async (t) => {
  let c = t, {allowedSighash: e, hex: n, signAtIndex: r, userSession: s} = c, o = f(c, ["allowedSighash", "hex", "signAtIndex", "userSession"]);
  if (g(s)) {
    let {privateKey: u, publicKey: l} = y(s), m = p(i({}, o), {allowedSighash: e, hex: n, signAtIndex: r, publicKey: l});
    return gt(m, u);
  }
  let a = i({}, o);
  return createUnsecuredToken(a);
};
async function St(t, e) {
  let n = await e(i(i({}, yt(t)), t));
  return xt({token: n, options: t});
}
function he(t) {
  return St(t, mt);
}
function Ct(t) {
  ...
  if (!e || !n)
    return;
  let r = (a = e == null ? void 0 : e.loadUserData().profile) == null ? void 0 : a.stxAddress, s = {[ChainID.Mainnet]: "mainnet", [ChainID.Testnet]: "testnet"};
...
var bt = async (t) => {
  let s = t, {userSession: e} = s, n = f(s, ["userSession"]);
  if (g(e)) {
    let {privateKey: o, publicKey: a} = y(e), c = p(i({}, n), {publicKey: a});
    return wt(c, o);
  }
  let r = i({}, n);
...
async function Ut(t, e) {
  let n = await e(i(i({}, b(t)), t));
  return It({token: n, options: t});
}
function F(t) {
  return p(i({}, t), {message: S(serializeCV(t.message)), domain: S(serializeCV(t.domain))});
}
async function Bt(t, e) {
  return new TokenSigner("ES256k", e).signAsync(F(t));
}
async function At(t) {
  let r = t, {userSession: e} = r, n = f(r, ["userSession"]);
  if (g(e)) {
    let {privateKey: s, publicKey: o} = y(e), a = p(i({}, n), {publicKey: o});
    return Bt(a, s);
  }
  return createUnsecuredToken(F(t));
}
...
var Xt = async (t) => {
  let o = t, {userSession: e, profile: n} = o, r = f(o, ["userSession", "profile"]);
  if (g(e)) {
    let {privateKey: a, publicKey: c} = y(e), u = p(i({}, r), {profile: n, publicKey: c});
    return Kt(u, a);
  }
  let s = i({}, r);
