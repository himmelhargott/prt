import { getGlobalObject, InvalidDIDError, nextMonth, makeUUID4, bytesToUtf8, hexToBytes, bytesToHex, utf8ToBytes, BLOCKSTACK_HANDLER as BLOCKSTACK_HANDLER$1, isSameOriginAbsoluteUrl, InvalidStateError, NoSessionDataError, MissingParameterError, nextHour, Logger, LoginFailedError, isLaterVersion, BLOCKSTACK_DEFAULT_GAIA_HUB_URL } from '../../../../../../../_snowpack/pkg/@stacks/common.js';
import { publicKeyToBtcAddress, decryptECIES, makeECPrivateKey, encryptECIES, isValidPrivateKey, encryptContent, decryptContent } from '../../../../../../../_snowpack/pkg/@stacks/encryption.js';
import { SECP256K1Client, TokenSigner, decodeToken, TokenVerifier } from '../../../../../../../_snowpack/pkg/jsontokens.js';
import { createFetchFn, StacksMainnet, StacksNetwork } from '../../../../../../../_snowpack/pkg/@stacks/network.js';
import { extractProfile, resolveZoneFileToProfile } from '../../../../../../../_snowpack/pkg/@stacks/profile.js';
