import { c as createCommonjsModule, b as commonjsRequire } from './_commonjsHelpers-16be0a9e.js';
import { a as async } from './async-37eab521.js';

var schemaInspector = createCommonjsModule(function (module) {
...
(function () {
  ...
  var _asyncValidationAttribut = {
    asyncExec: function (schema, candidate, callback) {
      var self = this;
      async$1.eachSeries(_typeIs.array(schema.exec) ? schema.exec : [schema.exec], function (exec, done) {
        if (typeof exec === 'function') {
          if (exec.length > 2) {
    ...
    asyncProperties: function (schema, candidate, callback) {
      ...
      async$1.series([
        function (next) {
          ...
          async$1.eachSeries(Object.keys(candidate), function (i, done) {
            if (i in properties) {
              return async$1.nextTick(done);
            }
        ...
        function (next) {
          async$1.eachSeries(Object.keys(properties), function (i, done) {
            if (i === '*') {
              return async$1.nextTick(done);
            }
            self._deeperObject(i);
    ...
    asyncItems: function (schema, candidate, callback) {
      ...
      if (_typeIs.array(items) && _typeIs.array(candidate)) {
        async$1.timesSeries(items.length, function (i, done) {
          self._deeperArray(i);
        ...
        async$1.eachSeries(Object.keys(candidate), function (key, done) {
  ...
  Validation.prototype.validate = function (candidate, callback) {
    ...
    if (typeof callback === 'function') {
      var self = this;
      return async$1.nextTick(function () {
  ...
  Validation.prototype._asyncValidate = function (schema, candidate, callback) {
    ...
    async$1.series([
      function (next) {
        async$1.eachSeries(Object.keys(_validationAttribut), function (i, done) {
          async$1.nextTick(function () {
      ...
      function (next) {
        async$1.eachSeries(Object.keys(self._custom), function (i, done) {
          async$1.nextTick(function () {
  ...
  var _asyncSanitizationAttribut = {
    asyncExec: function (schema, post, callback) {
      ...
      async$1.eachSeries(execs, function (exec, done) {
        if (typeof exec === 'function') {
          if (exec.length > 2) {
    ...
    asyncProperties: function (schema, post, callback) {
      ...
      async$1.series([
        function (next) {
          ...
          async$1.eachSeries(Object.keys(post), function (i, next) {
            if (i in properties) {
              return next();
            }
            self._deeperObject(i);
        ...
        function (next) {
          async$1.eachSeries(Object.keys(properties), function (i, next) {
            if (i === '*') {
              return next();
            }
            self._deeperObject(i);
    ...
    asyncItems: function (schema, post, callback) {
      ...
      if (_typeIs.array(items) && _typeIs.array(post)) {
        ...
        async$1.timesSeries(minLength, function (i, next) {
          self._deeperArray(i);
        ...
        async$1.eachSeries(Object.keys(post), function (key, next) {
          self._deeperArray(key);
  ...
  Sanitization.prototype._asyncSanitize = function (schema, post, callback) {
    ...
    async$1.waterfall([
      function (next) {
        async$1.reduce(self._basicFields, post, function (value, i, next) {
          async$1.nextTick(function () {
            if ((i in schema || i === 'optional') && typeof self[i] === 'function') {
              if (self[i].length > 2) {
      ...
      function (inter, next) {
        async$1.reduce(self._customFields, inter, function (value, i, next) {
          async$1.nextTick(function () {
            if (i in schema && typeof self._custom[i] === 'function') {
              if (self._custom[i].length > 2) {
...
var schemaInspector$1 = schemaInspector;

export { schemaInspector$1 as s };
